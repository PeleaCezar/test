...
var Renderer = /** @class */ (function () {
    ...
    Renderer.prototype.isTOC = function (para) {
        for (var i = 0; i < para.childWidgets[0].children.length; i++) {
            ...
            if (element instanceof FieldElementBox && !isNullOrUndefined(element.fieldSeparator) && !isNullOrUndefined(element.fieldSeparator.previousElement) && element.fieldSeparator.previousElement instanceof TextElementBox) {
                var textElementBox = element.fieldSeparator.previousElement;
                var fieldCode = textElementBox.text;
    ...
    Renderer.prototype.renderLine = function (lineWidget, page, left, top) {
        ...
        if (!isNullOrUndefined(lineWidget.paragraph.nextRenderedWidget)) {
            var para = lineWidget.paragraph.nextRenderedWidget;
