        ...
        if (!isNullOrUndefined(table.bodyWidget)) {
            ...
            table.bodyWidget.floatingElements.forEach(function (shape) {
                if (shape instanceof ShapeElementBox && !shape.paragraph.isInsideTable) {
                    ...
                    var tableWidget = new Rect(shape.x, shape.y, shape.width, shape.height);
                    if (tableRect_1.isIntersecting(tableWidget)) {
                            ...
                            if (this.isNeedDoIntermediateWrapping(remainingClientWidth, textWrappingType, rect, elementBox.width, elementBox.paragraph, textWrappingBounds, elementBox, minwidth, minimumWidthRequired)) {
                                ...
                                if (remainingClientWidth === 0 && textWrappingStyle === 'Square' && elementBox.width > 0 && bodyWidget.floatingElements[i] instanceof ShapeElementBox) {
                                    if (!isNullOrUndefined(elementBox.paragraph.nextRenderedWidget) && elementBox.paragraph.nextRenderedWidget.childWidgets.length != 0) {
                                        for (var i_2 = 0; i_2 < elementBox.paragraph.nextRenderedWidget.childWidgets.length; i_2++) {
                                            var length_1 = elementBox.paragraph.nextRenderedWidget.childWidgets[i_2].children.length;
                                            for (var j = 0; j < length_1; j++) {
                                                if (elementBox.paragraph.nextRenderedWidget.childWidgets[i_2].children[j] instanceof ImageElementBox) {
                                                    this.isYPositionUpdated = true;
                                                    rect.width = this.viewer.clientArea.width;
                                                    rect.height -= (textWrappingBounds.bottom - rect.y);
                                                    rect.y = textWrappingBounds.bottom;
    ...
    Layout.prototype.updateChildLocationForCellOrShape = function (top, widget) {
        ...
        for (var i = 0; i < container.childWidgets.length; i++) {
            ...
            if (container.childWidgets[i] instanceof ParagraphWidget) {
                ...
                for (var i_3 = 0; i_3 < para.childWidgets.length; i_3++) {
                    ...
                    for (var j = 0; j < line.children.length; j++) {
                        ...
                        if (child instanceof FootnoteElementBox) {
                            ...
                            if (!isNullOrUndefined(foot)) {
                                for (var i_4 = 0; i_4 < foot.bodyWidgets.length; i_4++) {
                                    if ((foot.bodyWidgets[i_4]).footNoteReference === child) {
                                        findIndex = i_4;
                                    }
                                }
                            }
