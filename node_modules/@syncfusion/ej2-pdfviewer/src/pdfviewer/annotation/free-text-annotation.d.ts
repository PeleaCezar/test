...
export declare class FreeTextAnnotation {
     ...
     * @private
     */
    renderFreeTextAnnotations(shapeAnnotations: any, pageNumber: number, isImportAction?: boolean, isAdddedProgrammatically?: boolean): void;
    /**
     * @param annotation
     * @private
     */
     ...
     * @private
     */
    saveFreeTextAnnotations(isAddedProgrammatically?: boolean): string;
